...
| Achar a norma pelo tema da ementa | `buscar_legislacao_federal` | `{"consulta": "proteção de dados pessoais", "limite": 5}` (param canônico `consulta`, uniforme com as demais buscas; `termo` ainda aceito como alias). |
